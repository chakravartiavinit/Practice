...
int main()
{
    ...
    while (t--)
    {
        ...
        for (int i = 0; i < n; ++i)
        {
            ...
            else if (stations[i] == 0 && flag == true)
            {
                actual[i] = min(actual[i], count);
            }
        }
        debug(actual);
        count = 0;
        ...
        for (int i = 0; i < m; ++i)
        {
            if (actual[pass[i] - 1] == 1e6)
            {
                cout << "-1 ";
            }
            else
            {
                cout << actual[pass[i] - 1] << " ";
            }
        }
        cout << "\n";
    }
