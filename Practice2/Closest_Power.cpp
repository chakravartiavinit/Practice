...
int main()
{
    ...
    while (t--)
    {
        ...
        debug(ans);
        unsigned long long gamma = n - 1;
        unsigned long long beta = n + 1;
        int count = 0;
        while (gamma >= 0 && count < 1e4)
        {
            if (isPower(gamma) == true)
            {
                break;
            }
            gamma--;
        ...
        count = 0;
        while (beta < 1e18 && count < 1e4)
        {
            if (isPower(beta) == true)
            {
                break;
            }
            beta++;
        ...
        unsigned long delta1 = n - gamma;
        unsigned long long delta2 = beta - n;
        if (delta1 < delta2)
        {
            cout << gamma << "\n";
        }
