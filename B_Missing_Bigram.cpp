...
/*###############################################################################################################################################*/
bool check(string st, vector<string> vt)
{
    vector<string> temp;
    for (int i = 0; i + 1 < st.length(); ++i)
    {
        string tempo;
        tempo.push_back(st[i]);
        tempo.push_back(st[i + 1]);
        temp.push_back(tempo);
    }
    if (temp.size() == vt.size() + 1)
    {
        return true;
    }
    return false;
...
int main()
{
    ...
    while (t--)
    {
        ...
        string temp1 = answer;
        if (check(answer, vt) == true)
        {
            cout << answer << "\n";
        }
        else
        {
            if (check(temp1 + "a", vt) == true)
            {
                cout << temp1 + "a"
                     << "\n";
            }
            else if (check("a" + temp1, vt) == true)
            {
                cout << "a" + temp1 << "\n";
            }
            else if (check("b" + temp1, vt) == true)
            {
                cout << "b" + temp1 << "\n";
            }
            else
