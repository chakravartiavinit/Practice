...
int main()
{
    ...
    cin.tie(NULL);
    cout.tie(NULL);
    vector<int> alpha(30000,0);
    string Brain_fuck_input;
    cin>>Brain_fuck_input;
    int i=0;
    int current=0;
    while(i<Brain_fuck_input.length())
    {
        if(Brain_fuck_input[i]=='+')
        {
            alpha[current]++;
        }
        else if(Brain_fuck_input[i]=='-')
        {
            alpha[current]--;
        }
        else if(Brain_fuck_input[i]=='<')
