...
/*###############################################################################################################################################*/
int answer(string alpha, string t)
{
    int sptr = alpha.length() - 1;

    int ans = 0;
    while (sptr >= 0 && alpha[sptr] != t[1])
    {
        sptr--;
        ans++;
    }
...
int main()
{
    ...
    while (t--)
    {
        ...
        string t3 = "50";
        string t4 = "75";
        int a1 = answer(alpha, t1);
        int a2 = answer(alpha, t2);
        int a3 = answer(alpha, t3);
        int a4 = answer(alpha, t4);
