...
int main()
{
    ...
    string alpha, beta;
    cin >> alpha >> beta;
    long long count_zero = 0, count_zero_one = 0, count_one_zero = 0, count_one = 0;
    for (int i = 0; i < alpha.length(); ++i)
    {
        ...
        if (alpha[i] == '0' && beta[i] == '1')
        {
            count_zero_one++;
        }
    }
    long long ans = count_zero * (1LL) * count_one + count_one_zero * (1LL) * count_zero_one;
    cout << ans << "\n";
}