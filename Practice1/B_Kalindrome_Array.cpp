...
/*###############################################################################################################################################*/
bool check(vector<int> &temp, int a)
{
    vector<int> changed;
...
int main()
{
    ...
    while (t--)
    {
        ...
        while (i < j)
        {
            ...
            {
                flag = false;
                potential.push_back(vt[i]);
                potential.push_back(vt[j]);
                break;
            }
        }
        if (flag == true)
        ...
        {
            if (check(vt, potential[0]) == true)
            {
                cout << "YES\n";
            }
            else
            {
                if (check(vt, potential[1]) == true)
                {
                    cout << "YES\n";
                }
                else
