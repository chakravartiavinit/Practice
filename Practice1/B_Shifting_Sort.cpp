...
/*###############################################################################################################################################*/
void rightRotateByOne(int start, int end, vector<long long> &arr)
{
    int last = arr[end];
...
void leftRotate(int start, int end, vector<long long> &arr)
{
    for (int i = 0; i < 1; i++)
    {
        rightRotateByOne(start, end, arr);
    }
}
int main()
{
    ...
    while (t--)
    {
        ...
        else
        {
            ...
            {
                cout << vp[i].first << " " << vp[i].second << " " << value[i] << "\n";
            }
        }
    }
}