...
int main()
{
    ...
    string alpha;
    cin >> alpha;
    bool found = false, found_x = false;
    for (auto x : alpha)
    {
        if (x == '_')
        {
    ...
    if (found == true || found_x == true)
    {
        ...
        {
            if (alpha[0] == '_' && alpha[1] == '_')
            {
                int t = 3;
                long long answer = 1;
                for (int i = 3; i < alpha.length(); ++)
                {
                    if (alpha[i] == 'X' || alpha[i] == '_')
                    {
                        answer += 10;
                    }
                }
            ...
            {
                if(alpha[1]=='2'||alpha[1]=='0'||alpha[1]=='5')
                {
                    if(alpha[0]=='0')
                    {
