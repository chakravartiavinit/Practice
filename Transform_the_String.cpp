...
/*###############################################################################################################################################*/
int ans(int start, set<int> &st, int count)
{
    ...
    if (start == 0)
    {
        return ans(26, st, count);
    }
    if (start == 26)
    {
        return ans(0, st, count);
    }
    return min(ans(start + 1, st, count + 1), ans(start - 1, st, count + 1));
}
int main()
{
#ifndef ONLINE_JUDGE
    ...
    for (int test = 1; test <= t; ++test)
    {
        ...
        for (int i = 0; i <= 26; ++i)
        {
            ...
            else
            {
                ...
                for (auto x : st)
                {
                    answer = min({answer, abs(x - i), 26 - abs(x - i)});
                }
                mp[i] = answer;
            }
        }
