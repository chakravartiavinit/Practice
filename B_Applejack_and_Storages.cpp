...
int main()
{
    ...
    for (auto x : mp)
    {
        if (x.second >= 8)
        {
            values[8].insert(x.first);
        }
        else if (x.second >= 6)
        {
            values[6].insert(x.first);
        }
        else if (x.second >= 4)
        {
            values[4].insert(x.first);
        }
        else if (x.second >= 2)
        {
            values[2].insert(x.first);
        }
    }
    int q;
    cin >> q;
    while (q--)
    {
        ...
        if ((values[8].size() >= 1) || (values[6].size() >= 1 && values[2].size() >= 1) || (values[4].size() >= 1 && values[2].size() >= 1))
        {
            cout << "YES\n";
        }
        else
