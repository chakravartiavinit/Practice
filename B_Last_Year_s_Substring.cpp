...
/*###############################################################################################################################################*/
bool check(string alpha,int n)
{
    if(alpha[0]=='2'&&alpha[1]=='0'&&alpha[2]=='2'&&alpha[3]=='0')
    {
        return true;
    }
    else if(alpha[0]=='2'&&alpha[n-1]=='0'&&alpha[n-2]=='2'&&alpha[n-3]=='0')
    {
        return true;
    }
    else if(alpha[0]=='2'&&alpha[1]=='0'&&alpha[n-1]=='0'&&alpha[n-2]=='2')
    {
        return true;
    }
    else if(alpha[0]=='2'&&alpha[1]=='0'&&alpha[2]=='2'&&alpha[n-1]=='0')
    {
        return true;
    }
    else if(alpha[n-1]=='0'&&alpha[n-2]=='2'&&alpha[n-3]=='0'&&alpha[n-4]=='2')
    {
        return true;
    }
    return false;
